const ru: Record<string, string> = {
  ...
  "topics.reset.body":
    "Удаляет записи о загрузках, прогресс по сериям и состояние ошибки, затем сразу проверяет тему заново, чтобы текущий выпуск считался новым. Темы с загрузкой скачают его снова. Темы «только уведомления» обнаружат его молча, если не включено уведомление о выпуске, который уже есть. Настройки и история событий сохраняются. Приостановленная тема останется приостановленной.",
  ...
  // Режим «только уведомления» (issue #184) — тема отслеживается и
  // анонсируется, но никогда не отправляется торрент-клиенту.
  "topics.notifyOnly.badge": "Только уведомления",
  "topics.notifyOnly.label": "Только уведомления — не скачивать",
  "topics.notifyOnly.help":
    "Продолжать проверять эту тему и присылать уведомление о новом выпуске, ничего не отправляя торрент-клиенту. Клиент для загрузки не нужен.",
  "topics.notifyOnly.announceCurrent":
    "Сообщить и о выпуске, который есть сейчас",
  "topics.notifyOnly.silentWarning":
    "У этой темы нет уведомителя, подписанного на новые выпуски, поэтому она будет проверяться молча и вы ничего о ней не узнаете. Выберите ниже уведомитель, который получает новые выпуски, или назначьте уведомитель по умолчанию на странице «Уведомления».",

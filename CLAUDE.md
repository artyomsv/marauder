...
1. `loadCredentials` — fetches and decrypts tracker credentials (if the
   ...
   (Verify-first, Login-on-miss, single-flight per tracker+user — issue #198).

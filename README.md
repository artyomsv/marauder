...
[![Release: v1.14.0](https://img.shields.io/badge/release-v1.14.0-success.svg)](CHANGELOG.md)
...
**v1.14.0** — latest release (v1.0.0 was the initial production cut;
...
in `.env` (defaults to `1.14.0`); `latest` also exists.

...
[![Release: v1.20.1](https://img.shields.io/badge/release-v1.20.1-success.svg)](CHANGELOG.md)
...
**v1.20.1** — latest release (v1.0.0 was the initial production cut;
...
in `.env` (defaults to `1.20.1`); `latest` also exists.

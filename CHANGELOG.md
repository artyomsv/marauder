...
- `/health`, `/api/v1/system/info`, and `/api/v1/auth/login` all return
  valid responses through the nginx gateway, and login issues a
  correctly-formed ES256 JWT with the expected claims.
